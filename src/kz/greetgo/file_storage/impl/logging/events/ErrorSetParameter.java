...
public class ErrorSetParameter implements FileStorageLoggerErrorEvent {
  private final java.util.Date happenedAt = new java.util.Date();
  public final String sql;
  public final List<Object> params;
  public final int settingParameterIndex;
  public final Exception e;
  public final long startedAt;
  public final long preparedAt;
  public final long errorAt;

  public ErrorSetParameter(String sql, List<Object> params, int settingParameterIndex, Exception e,
                           long startedAt, long preparedAt, long errorAt) {
    this.sql = sql;
    this.params = params;
    this.settingParameterIndex = settingParameterIndex;
    this.e = e;
