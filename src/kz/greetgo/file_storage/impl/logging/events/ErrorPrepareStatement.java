...
public class ErrorPrepareStatement implements FileStorageLoggerErrorEvent {
  ...
  public ErrorPrepareStatement(String sql, Exception e, long startedAt, long errorAt) {
    this.sql = sql;
    this.e = e;
