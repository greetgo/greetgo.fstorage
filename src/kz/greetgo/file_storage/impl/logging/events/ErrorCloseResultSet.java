...
public class ErrorCloseResultSet implements FileStorageLoggerErrorEvent {
  ...
  public ErrorCloseResultSet(String sql, List<Object> params, Exception e, long startedAt, long preparedAt, long errorAt) {
    this.sql = sql;
    this.params = params;
    this.e = e;
