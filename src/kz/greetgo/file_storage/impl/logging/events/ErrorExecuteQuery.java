...
public class ErrorExecuteQuery implements FileStorageLoggerErrorEvent {
  ...
  public ErrorExecuteQuery(String sql, List<Object> params, Exception e, long startedAt, long preparedAt, long errorAt) {
    this.sql = sql;
    this.params = params;
    this.e = e;
